  ...
  return (
    <div className={`${bgColor} rounded-3xl p-3 sm:p-8`}>
      <div className="bg-white rounded-3xl p-6 sm:p-12">
        <h2 className="text-2xl sm:text-3xl mb-8 sm:mb-12 text-blue-600">パスワード変更</h2>
        
        <div className="space-y-6 sm:space-y-8 max-w-2xl">
          <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-4">
            <label className="text-blue-600 min-w-[140px] sm:min-w-[180px]">新しいパスワード</label>
            <input
              type="password"
          ...
          <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-4">
            <label className="text-blue-600 min-w-[140px] sm:min-w-[180px]">確認用パスワード</label>
            <input
              type="password"
              className="flex-1 border-2 border-gray-800 rounded-lg px-4 py-2"
            />
