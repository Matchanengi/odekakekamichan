      ...
      <div className="bg-white rounded-3xl p-6 sm:p-12">
        ...
        <div className="border-2 border-black rounded-lg p-6 bg-white h-[400px] sm:h-[500px] overflow-y-auto mb-6">
          <div className="space-y-6">
            ...
            <div>
              <h3 className="mb-2">第2条(おでかけかみちゃんについて)</h3>
              <p className="leading-relaxed">
            ...
            <div>
              <h3 className="mb-2">第3条(利用者の義務)</h3>
              <p className="leading-relaxed">
            ...
            <div>
              <h3 className="mb-2">第4条(個人情報の取り扱い)</h3>
              <p className="leading-relaxed">
                当社は、利用者の個人情報を適切に管理し、本サービスの提供以外の目的で使用することはありません詳細は、別途定めるプライバシーポリシーをご確認ください。
              </p>
            </div>

            <div>
              <h3 className="mb-2">第5条(免責事項)</h3>
              <p className="leading-relaxed">
            ...
            <div>
              <h3 className="mb-2">第6条(規約の変更)</h3>
              <p className="leading-relaxed">
